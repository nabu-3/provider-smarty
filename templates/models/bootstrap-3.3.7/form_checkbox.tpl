...
<div class="form-group">
    ...
    <div class="checkbox"><label><input type="checkbox"{if isset($check)} value="{$check|escape:"html"}"{if $value===$check} checked{/if}{/if}>{if isset($label) && is_string($label)}{$label}{/if}</label></div>
